        ...
        <div class="card-body">
            ...
            <div class="row">
                <div class="col-md-6 border-right-2 border-right-blue-400">
                        ...
                        <div class="form-group row">
                            <label class="col-lg-3 col-form-label font-weight-semibold">Akhir Semester</label>
                            <div class="col-lg-6">
                        ...
                        <div class="form-group row">
                            <label class="col-lg-3 col-form-label font-weight-semibold">Awal Semester</label>
                            <div class="col-lg-6">
