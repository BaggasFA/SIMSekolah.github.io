...
@section('page_title', 'Student Information - '.$my_class->name. ' Session '. $session)
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body">
            <ul class="nav nav-tabs nav-tabs-highlight">
                <li class="nav-item"><a href="#all-students" class="nav-link active" data-toggle="tab">Semua Siswa {{ $my_class->name }}</a></li>
