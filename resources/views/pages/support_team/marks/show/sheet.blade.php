<table class="table table-bordered table-responsive text-center">
    ...
    <tr>
        ...
        <th rowspan="2">ULANGAN HARIAN 1<br>(20)</th>
        <th rowspan="2">ULANGAN HARIAN 2<br>(20)</th>
        ...
        <th rowspan="2">POSISI <br> PADA MATA PELAJARAN</th>
    ...
    @endforeach
    <tr>
        <td colspan="4"><strong>TOTAL NILAI: </strong> {{ $exr->total }}</td>
        <td colspan="3"><strong>RATA-RATA: </strong> {{ $exr->ave }}</td>
