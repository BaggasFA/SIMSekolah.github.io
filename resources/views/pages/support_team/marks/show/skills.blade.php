    ...
    <div class="col-md-6">
        <div class="card">
            <div class="card-header header-elements-inline bg-danger">
                <h6 class="card-title font-weight-bold">SKILL AFEKTIF</h6>
                {!! Qs::getPanelOptions() !!}
            </div>
                ...
                <form class="ajax-update" method="post" action="{{ route('marks.skills_update', ['AF', $exr->id]) }}">
                    ...
                    @foreach($skills->where('skill_type', 'AF') as $af)
                        <div class="form-group row">
                            ...
                            <div class="col-lg-6">
                                @if (Qs::getUserType() == 'student' || Qs::getUserType() == 'parent')
                                    <select data-placeholder="Select" name="ps[]" id="ps" class="form-control select" disabled>
                                @else
    ...
    <div class="col-md-6">
        <div class="card">
            <div class="card-header header-elements-inline bg-success">
                <h6 class="card-title font-weight-bold">SKILL PSIKOMOTORIK</h6>
                {!! Qs::getPanelOptions() !!}
            </div>
