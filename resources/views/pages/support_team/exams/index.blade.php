    ...
    <div class="card">
        ...
        <div class="card-body">
            <ul class="nav nav-tabs nav-tabs-highlight">
                <li class="nav-item"><a href="#all-exams" class="nav-link active" data-toggle="tab">Manage Ujian</a></li>
                <li class="nav-item"><a href="#new-exam" class="nav-link" data-toggle="tab"><i class="icon-plus2"></i> Tambah Ujian</a></li>
            </ul>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="alert alert-info border-0 alert-dismissible">
                                ...
                                <span>Anda menambahkan ujian pada sesi <strong>{{ Qs::getSetting('current_session') }}</strong></span>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        <select data-placeholder="Select Teacher" class="form-control select-search" name="term" id="term">
                                            <option {{ old('term') == 1 ? 'selected' : '' }} value="1">Semester Satu</option>
                                            <option {{ old('term') == 2 ? 'selected' : '' }} value="2">Semester Dua</option>
                                        </select>
                                    </div>
                                </div>
