    ...
    <div class="card">
        ...
        <div class="card-body">
            <ul class="nav nav-tabs nav-tabs-highlight">
                <li class="nav-item"><a href="#change-pass" class="nav-link active" data-toggle="tab">Ubah Password</a></li>
                @if(Qs::userIsPTA())
                    <li class="nav-item"><a href="#edit-profile" class="nav-link" data-toggle="tab"><i class="icon-plus2"></i> Manage Profil</a></li>
                @endif
            </ul>
                                ...
                                <form enctype="multipart/form-data" method="post" action="{{ route('my_account.update') }}">
                                    ...
                                    @if($my->username)
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-9">
                                                <input id="username" name="username" class="form-control" type="text" value="{{ $my->username }}">
                                            </div>
                                        </div>
                                    ...
                                    <div class="form-group row">
                                        <label for="phone" class="col-lg-3 col-form-label font-weight-semibold">No.Hp </label>
                                        <div class="col-lg-9">
                                    ...
                                    <div class="form-group row">
                                        <label for="phone2" class="col-lg-3 col-form-label font-weight-semibold">No.Telp </label>
                                        <div class="col-lg-9">
