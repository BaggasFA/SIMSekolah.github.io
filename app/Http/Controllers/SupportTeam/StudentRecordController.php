...
class StudentRecordController extends Controller
{
   ...
   public function __construct(LocationRepo $loc, MyClassRepo $my_class, UserRepo $user, StudentRepo $student)
   {
    ...
    public function create()
    {
        ...
        $data['kecamatans'] = $this->loc->getKecamatans();
    ...
    public function store(StudentRecordCreate $req)
    {
       ...
       /* $ct = ($ct == 'J') ? 'JSS' : $ct;
        ...
        if($req->hasFile('photo')) {
            ...
            $f['name'] = 'photo.' . $f['ext'];
            $path = Qs::getUploadPath('student').$data['code'].'/'.$f['name'];
            $f['path'] = $photo->storeAs('public/'.Qs::getUploadPath('student').$data['code'], $f['name']);
    ...
    {   $data['session'] = Qs::getSetting('current_session');
        ...
        $data['students'] = $this->student->findStudentsByClass($class_id, $data['session']);
    ...
    public function update(StudentRecordUpdate $req, $sr_id)
    {
        ...
        if($req->hasFile('photo')) {
            ...
            $f = Qs::getFileMetaData($photo);
            $f['name'] = 'photo.' . $f['ext'];
            $path = Qs::getUploadPath('student').$sr->user->code.'/'.$f['name'];
            $f['path'] = $photo->storeAs('public/'.Qs::getUploadPath('student').$sr->user->code, $f['name']);
            $d['photo'] = asset('storage/' . $path);
        }
    ...
    public function destroy($st_id)
    {
        ...
        $path = 'public/'.Qs::getUploadPath('student').$sr->user->code;
