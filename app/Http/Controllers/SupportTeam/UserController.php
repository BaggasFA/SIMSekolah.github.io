...
class UserController extends Controller
{
    ...
    public function index()
    {
        ...
        $d['kecamatans'] = $this->loc->getKecamatans();
    ...
    public function store(UserRequest $req)
    {
        ...
        if($req->hasFile('photo')) {
            ...
            $f['name'] = 'photo.' . $f['ext'];
            $path = Qs::getUploadPath($user_type).$data['code'].'/'.$f['name'];
    ...
    public function update(UserRequest $req, $id)
    {
        ...
        if($req->hasFile('photo')) {
            ...
            $f = Qs::getFileMetaData($photo);
            $f['name'] = 'photo.' . $f['ext'];
            $path = Qs::getUploadPath($user_type).$user['code'].'/'.$f['name'];
            $f['path'] = $photo->storeAs('public/'.Qs::getUploadPath($user_type).$user['code'], $f['name']);
            $data['photo'] = asset('storage/' . $path);
        }
    ...
    public function destroy($id)
    {
        ...
        $path = 'public/'.Qs::getUploadPath($user->user_type).$user->code;
