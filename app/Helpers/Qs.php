...
class Qs
{
    ...
    {
        return self::getSetting('system_title') ?: 'SIM Sekolah';
    }
 ...
 <div class="alert alert-success alert-bordered">
    ...
    {
        $data = ['name', 'email', 'phone', 'phone2', 'gender', 'address', 'kecamatan_id', 'dob'];
    ...
    {
        $data = ['my_class_id', 'section_id', 'my_parent_id', 'year_admitted', 'age', 'dob'];
    ...
    public static function getMarkType($class_type)
    {
       switch($class_type){
           case 'I' : return 'satu';
           case 'II' : return 'dua';
           case 'III' : return 'tiga';
           case 'IV' : return 'empat';
           case 'V' : return 'lima';
           case 'VI' : return 'enam';
       }
        return $class_type;
